        ...
        <div class="w-full flex">
          <div class="pl-6 pr-4 mr-4 w-1/3">
            <div class="card mb-4">
              ...
              <div class="sns">
                <a v-if="currentUser.own_url" :href="currentUser.own_url">
                  <svg
                ...
                <a
                  v-if="currentUser.linked_in_url"
                  :href="currentUser.linked_in_url"
                  class="sns-link"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
